...
assert.match(app, /E6\.2 PROCESS ENGINE COMPLETO/);
...
assert.equal(buildInfo.release, "E6.2 Process Engine Completo");

console.log("FMED E6.2 Light Comfort compatibility: OK");
