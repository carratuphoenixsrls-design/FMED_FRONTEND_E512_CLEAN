...
const version = "FMED_ENTERPRISE_1_0_E7_1_DASHBOARD_ENTERPRISE_2026_07_19";
if (!app.includes(version)) throw new Error("Versione E7.1 assente in App_nuovo.jsx");
if (!app.includes("FMED ENTERPRISE 1.0 · E7.1 DASHBOARD ENTERPRISE")) throw new Error("Build label E7.1 assente");
...
console.log("FMED E7.1 release finale: OK");
